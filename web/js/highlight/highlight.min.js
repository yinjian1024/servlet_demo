...
;hljs.registerLanguage("python-repl",a)})();/*! `haml` grammar compiled for Highlight.js 11.5.1 */
...
;hljs.registerLanguage("haml",e)})();/*! `pgsql` grammar compiled for Highlight.js 11.5.1 */
(()=>{var E=(()=>{"use strict";return E=>{
...
})();hljs.registerLanguage("pgsql",E)})();/*! `php-template` grammar compiled for Highlight.js 11.5.1 */
...
;hljs.registerLanguage("php-template",n)})();/*! `powershell` grammar compiled for Highlight.js 11.5.1 */
...
;hljs.registerLanguage("powershell",e)})();/*! `kotlin` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict"
